...
REM Configure git user if this is first time
echo [0/3] Setting up Git...
git config --global user.name "Tire Inventory System" 2>nul
git config --global user.email "inventory@local" 2>nul
